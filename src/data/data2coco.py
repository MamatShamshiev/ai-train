...
from defs import BASELINE_ROOT, RAW_DATA_PATH
from tqdm import tqdm

PATH_TO_GT_BOXES = RAW_DATA_PATH / "bboxes"
PATH_TO_DET_ANN_TEMPLATE = BASELINE_ROOT / "evaluation" / "det_ann_template.json"
PATH_TO_GT_ANN = RAW_DATA_PATH / "detection_coco.json"


def make_coco_detection_ann(path_to_bboxes, ann_template):
    class2id = {el["name"]: el["id"] for el in ann_template["categories"]}

    for file_name in tqdm(os.listdir(path_to_bboxes)):
